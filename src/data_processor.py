...
class DataProcessor(object):
    ...
    def get_tensor(self, data_name, max_seq_length, drop_o_ratio=0, drop_e_ratio=0):
        ...
        if os.path.exists(data_file) : # Change made to load tensor from data file
            ...
            #raw_tokens = [data[0].split() for data in all_data]  # ✅ Extract raw tokens from text
            raw_tokens = [data[0].split() for data in all_data]
            all_input_ids = []
            all_attention_mask = []
            all_labels = []
            all_valid_pos = []
            ...
            tensor_data = {
                ...
                #"raw_tokens": raw_tokens  # ✅ Added raw_tokens Check the docs if this is required. Remove
            }

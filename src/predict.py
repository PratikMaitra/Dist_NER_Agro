...
def main():
    ...
    elif "Maize" in args.dataset_name:
        args.priors = [0.0382405850627, 0.00994870190668]
    elif "SoyBase" in args.dataset_name:
        args.priors = [0.0382405850627, 0.00994870190668]
    elif "Grain" in args.dataset_name:
        args.priors = [0.0382405850627, 0.00994870190668]
    elif "Allcrops" in args.dataset_name:
        args.priors = [0.0382405850627, 0.00994870190668]
    else:
        args.priors = [0.0314966102568, 0.0376880632424, 0.0354240324761, 0.015502139428]
    ...
    trainer.load_model(os.path.join(args.output_dir, "model_4"))
